...
Ref. Amazon Broadcastr: [LLMs for the rest of us – Build open source LLMs & democratize GenAI w/ Hugging Face](https://broadcast.amazon.com/videos/819711) (Blue color -> can use commercially)
